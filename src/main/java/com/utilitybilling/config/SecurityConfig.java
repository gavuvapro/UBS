...
import com.utilitybilling.security.JwtAuthFilter;
 ...
 * Configures endpoint access rules, CORS, password encoding, and the JWT filter chain.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    /**
     * Configures the DAO authentication provider with BCrypt password hashing.
     */
    @Bean
    ...
    /**
     * Exposes the AuthenticationManager for use in authentication services.
     */
    @Bean
